...
class tc_ID82626_HYPERV_check_rhsm_hostname_port_prefix(HYPERVBase):
    def test_run(self):
        ...
        try:
            ...
            self.set_rhsm_hostname_prefix_port("hyperv", server_user, server_pass, "https://"+server_hostname ,server_port, server_prefix)
            self.vw_check_mapping_info_number_in_rhsm_log()
