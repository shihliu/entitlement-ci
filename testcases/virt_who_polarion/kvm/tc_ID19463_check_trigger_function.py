...
class tc_ID19463_check_trigger_function(KVMBase):
    def test_run(self):
        ...
        try:
            ...
            self.vw_check_attr(guest_name, 1, 'libvirt', 1, guestuuid, checkcmd=check_start, waiting_time=20)
            self.vw_check_message_number_in_rhsm_log(check_msg, checkcmd=check_suspend)
            ...
            self.vw_check_attr(guest_name, 1, 'libvirt', 3, guestuuid, checkcmd=check_suspend, waiting_time=80)
