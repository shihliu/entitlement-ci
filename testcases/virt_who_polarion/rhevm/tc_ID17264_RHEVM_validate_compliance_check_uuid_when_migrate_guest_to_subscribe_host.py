...
class tc_ID17264_RHEVM_validate_compliance_check_uuid_when_migrate_guest_to_subscribe_host(VDSMBase):
    def test_run(self):
        ...
        try:
            ...
            # (2) Subscribe dest hypervisor to the physical pool and guest subscribe bonus pool before migration
            self.server_subscribe_system(dest_host_uuid, self.get_poolid_by_SKU(test_sku), SERVER_IP)
