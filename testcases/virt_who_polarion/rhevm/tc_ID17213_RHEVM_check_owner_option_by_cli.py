...
class tc_ID17213_RHEVM_check_owner_option_by_cli(VDSMBase):
    def test_run(self):
        ...
        try:
            ...
            cmd_with_wrong_owner = "virt-who --rhevm --rhevm-owner=%s --rhevm-env=%s --rhevm-server=%s --rhevm-username=%s --rhevm-password=%s" % ("xxxxxxx", rhevm_env, rhevm_server, rhevm_username, rhevm_password) + " -o -d"
