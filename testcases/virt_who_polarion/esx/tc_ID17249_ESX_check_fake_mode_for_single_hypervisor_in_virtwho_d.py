...
class tc_ID17249_ESX_check_fake_mode_for_single_hypervisor_in_virtwho_d(ESXBase):
    def test_run(self):
        ...
        try:
            ...
            self.unset_esx_conf()
            virtwho_owner = self.get_vw_cons("VIRTWHO_ESX_OWNER")
            virtwho_env = self.get_vw_cons("VIRTWHO_ESX_ENV")
