...
class tc_ID17248_ESX_check_hypervisor_id_exclude_host_uuids_in_virtwho_d(ESXBase):
    def test_run(self):
        ...
        try:
            ...
            self.set_hypervisor_id_exclude_host_uuids("esx", "uuid", host_uuid)
            ...
            self.set_hypervisor_id_exclude_host_uuids("esx", "hostname", esx_host_name)
            self.vw_check_mapping_info_in_rhsm_log(esx_host_name, guest_uuid, uuid_exist=False)
            self.vw_check_mapping_info_in_rhsm_log(esx_host_name_second)
