...
class tc_ID509754_list_available_releases_with_textural_banner(RHSMBase):
    def test_run(self):
        ...
        try:
            ...
            if ret == 0 and latest_release in output and '+-------------------------------------------+' in output and 'Available Releases' in output:
