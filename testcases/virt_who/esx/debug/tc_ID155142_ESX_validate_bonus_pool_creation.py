...
class tc_ID155142_ESX_validate_bonus_pool_creation(VIRTWHOBase):
    def test_run(self):
        ...
        try:
            ...
            self.server_subscribe_system(host_uuid, self.get_poolid_by_SKU(test_sku), SAM_IP)
            ...
            self.server_unsubscribe_all_system(host_uuid, SAM_IP)
