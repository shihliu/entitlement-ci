...
class tc_ID477171_ESX_run_virtwho_with_filter_host_uuids_null(ESXBase):
    def test_run(self):
        ...
        try:
            ...
            # creat /etc/virt-who.d/virt.esx file for esxi with filter_host_uuids=""
            conf_file = "/etc/virt-who.d/virt.esx"
            self.esx_set_filter_host_uuids("", conf_file, esx_owner, esx_env, esx_server, esx_username, esx_password)
