...
def tc_ID301085_ESX_Instance_compliance_in_guest_regardless_sockets_RAM_cores(params):
	...
	try:
		try:
			...
			eu().setup_custom_facts(logger, "memory.memtotal", "30000000", guestip)
			eu().setup_custom_facts(logger, "cpu.core(s)_per_socket", "8", guestip)
