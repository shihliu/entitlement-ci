...
class tc_ID477183_ESX_run_virtwho_with_rhsm_username_password(ESXBase):
    def test_run(self):
        ...
        try:
            ...
            # creat /etc/virt-who.d/virt.esx file for esxi with rhsm_username and rhsm_password
            conf_file = "/etc/virt-who.d/virt.esx"
            self.esx_set_rhsm_user_pass(server_user, server_pass, conf_file, esx_owner, esx_env, esx_server, esx_username, esx_password)
