...
def tc_ID289216_ESX_Datacenter_1_subscription_sufficient_to_guest(params):
	''' tc_ID289216_ESX_Datacenter_1_subscription_sufficient_to_guest '''
	try:
		try:
			...
			# Set up guest facts
			eu().setup_custom_facts(logger, "cpu.cpu_socket(s)", "4", guestip)
