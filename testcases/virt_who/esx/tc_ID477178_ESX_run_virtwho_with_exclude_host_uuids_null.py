...
class tc_ID477178_ESX_run_virtwho_with_exclude_host_uuids_null(VIRTWHOBase):
    def test_run(self):
...
env=%s''' % (VIRTWHO_ESX_SERVER, VIRTWHO_ESX_USERNAME, VIRTWHO_ESX_PASSWORD, VIRTWHO_ESX_OWNER, VIRTWHO_ESX_ENV)
            ...
            if virtwho_status == "running" or virtwho_status == "active":
                logger.info("Succeeded to check, virt-who is running whit exclude_host_uuids_null.")
            else:
