...
class tc_ID155208_RHEVM_check_uuid_with_none_guest(VDSMBase):
    def test_run(self):
        ...
        try:
            ...
            hostuuid = self.get_host_uuid_on_rhevm(orig_hostname, rhevm_ip)
            ...
            self.hypervisor_check_uuid(hostuuid, "", uuidexists=True)
