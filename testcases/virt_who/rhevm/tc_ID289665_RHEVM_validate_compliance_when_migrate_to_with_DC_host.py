...
class tc_ID289665_RHEVM_validate_compliance_when_migrate_to_with_DC_host(VDSMBase):
    def test_run(self):
        ...
        try:
            ...
            # subscribe the orig hypervisor to the physical pool which can generate bonus pool
            ...
            # subscribe the dest hypervisor to the physical pool which can generate bonus pool
            ...
            # unsubscribe all subscriptions on orig hypervisor and dest hypervisor
